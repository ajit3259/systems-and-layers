...
tags: [rest, grpc, graphql, websocket, sse, mqtt, http, tcp, protobuf]
mermaid: true
---

# API Patterns — Part 2: Under the Hood

← [Part 1: The Decision Framework](../api-patterns-part-1-decision-framework/) 
...
→ [Part 3: Hands-on Code](../api-patterns-part-3-hands-on/)
