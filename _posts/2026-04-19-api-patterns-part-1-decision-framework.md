...
date: 2026-04-19
categories: [Systems, API-Patterns]
tags: [rest, grpc, graphql, websocket, sse, mqtt, system-design, first-principles]
---
...
This is Part 1 — the decision framework. It gives you a mental model to reason about the choice and a story-driven walkthrough to see each option in context. [Part 2](../api-patterns-part-2-under-the-hood/) goes under the hood: how each style actually works and where it breaks. [Part 3](../api-patterns-part-3-hands-on/) has hands-on implementations.
